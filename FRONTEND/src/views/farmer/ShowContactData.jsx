...
//     doc.text('Invoice for Request the field officer', 10, 55);
...
//       ['Reason', request.reason, { alignment: 'justify' }],
//     ];
...
const ContactFieldOff = () => {
  ...
  const handleDeleteRequest = async (requestId) => {
    ...
    if (confirmed.isConfirmed) {
      try {
        await axios.delete(`http://localhost:3007/api/v1/farmer/contactfo/${requestId}`);
